            ...
            <div class="col-sm-6 col-lg-3">
              <div class="form-group hide">
                <div class="input-group">
                  ...
                  <div class="input-group-content">
                    <input readonly type="text" name="format_number" id="format_number2" class="form-control" maxlength="6" value="<?= $_SESSION['order']['format_number']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_format_number'); ?>" required>
                    <label for="document_number">Document No.</label>
                  </div>
                  <div class="input-group-content">
                    <input readonly type="text" name="document_number" id="document_number2" class="form-control" maxlength="7" value="<?= $_SESSION['order']['document_number']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_doc_number'); ?>" required>
                    <!-- <label for="document_number">Document No.</label> -->
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6"">
                    <input readonly type=" text" name="document_number" id="document_number" class="form-control" maxlength="7" value="<?= $_SESSION['order']['document_number']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_doc_number'); ?>" required>
    ...
    $(buttonEditDocumentItem).on('click', function(e) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#purchase_request_number').val(response.purchase_request_number);
