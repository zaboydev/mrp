            ...
            <table class="table table-hover" id="table-document">
              <thead>
                <tr>
                  ...
                  <th class="middle-alignment">Unit Price <!-- <?=$_SESSION['order']['default_currency'];?> --></th>
                  <th class="middle-alignment">Core Charge <!-- <?=$_SESSION['order']['default_currency'];?> --></th>
                  <th class="middle-alignment">Total Amount <!-- <?=$_SESSION['order']['default_currency'];?> --></th>
