      ...
      <?=form_open(current_url(), array('autocomplete' => 'off', 'class' => 'form form-validate', 'id' => 'form-create-document'));?>
        <div class="card">
          ...
          <div class="card-body no-padding">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <input type="text" name="mixing_item" id="mixing_item" class="form-control" value="<?=$_SESSION['mix']['mixing_item'];?>" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_mixing_item');?>" required>
                    <label for="mixing_item">Mixing Item</label>
                  </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <textarea name="remarks" id="remarks" class="form-control" rows="4" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_remarks');?>"><?=$_SESSION['mix']['remarks'];?></textarea>
            ...
            <?php if (isset($_SESSION['mix']['items'])):?>
              <div class="document-data table-responsive">
                <table class="table table-hover" id="table-document">
                  ...
                  <tbody>
                    <?php foreach ($_SESSION['mix']['items'] as $i => $items):?>
                      <tr id="row_<?=$i;?>">
                        <td width="1">
                ...
                <div class="form-group">
                  <div class="input-group">
                    <div class="input-group-content">
                      <input type="text" id="search_purchase_order" data-search-for="purchase_order" class="form-control" data-source="<?=site_url($modules['ajax']['route'] .'/get_purchase_order/'. config_item('auth_warehouse') .'/'. $_SESSION['usage']['category']);?>">
                ...
                <div class="row">
                  <div class="col-sm-6 col-lg-8">
                    <fieldset>
                      ...
                      <div class="form-group">
                        <input type="text" name="description" id="description" data-tag-name="item_description" data-search-for="item_description" class="form-control input-sm" data-source="<?=site_url($modules['ajax']['route'] .'/json_item_description/'. $_SESSION['mix']['category']);?>" required>
                        <label for="description">Description</label>
                      </div>

                      <div class="form-group">
                        <input type="text" name="alternate_part_number" id="alternate_part_number" data-tag-name="alternate_part_number" data-source="<?=site_url($modules['ajax']['route'] .'/json_alternate_part_number/'. $_SESSION['mix']['category']);?>" class="form-control input-sm">
                      ...
                      <div class="form-group">
                        <select name="group" id="group" data-tag-name="group" class="form-control input-sm" required>
                          ...
                          <?php foreach (available_item_groups($_SESSION['mix']['category']) as $group):?>
                            <option value="<?=$group;?>">
                              <?=$group;?>
                            </option>
                          <?php endforeach;?>
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" id="received_unit_value" name="received_unit_value" value="0">
                      </div>
                      ...
                      <div class="form-group">
                        <input type="text" name="stores" id="stores" data-tag-name="stores" data-search-for="stores" data-source="<?=site_url($modules['ajax']['route'] .'/json_stores/'. $_SESSION['mix']['category']);?>" class="form-control input-sm" required>
    ...
    success: function (resource) {
      $('#search_purchase_order').autocomplete({
        ...
        select: function( event, ui ) {
          ...
          $('#received_quantity').val( ui.item.quantity );
          $('#unit').val( ui.item.unit );
          $('#received_unit_value').val( ui.item.unit_value );
          $('#purchase_order_item_id').val( ui.item.id );
          $('#purchase_order_number').val( ui.item.mixing_item );
          $('#received_quantity').data('rule-max', ui.item.quantity).data('msg-max', 'max available '+ ui.item.quantity);
