...
<div class="container">
    ...
    <form id="form_add_vendor" id="inputForm" class="form" role="form" method="post" enctype="multipart/form-data" action="<?=site_url($module['route'] .'/add_attachment_detail');?>">
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="hidden" name="id_poe" id="id_poe" value="<?=$item_id?>">
                    <input type="hidden" name="tipe" id="tipe" value="<?=$type?>">
                </div>
            </div>
            <div class="clearfix">
    ...
    <div class="row" style="margin-top: 30px">
        <div class="col-md-12">
            ...
            <table style="width: 100%">
                ...
                <tbody>
                <?php if(sizeof($_SESSION['sppd']["attachment_detail"])>0):?>
                <?php $x=1;$y=0;?>
                <?php foreach ($_SESSION['sppd']["attachment_detail"] as $key) :?>
                    <?php 
                        $att = explode("|,", $key);
                    ?>
                    <?php if($att[1]==$item_id):?>
                    <tr>
                        <td><?=$x++?> </td>
                        <td><a href="<?=base_url().$att[0]?>"><?=$att[0]?></a></td>
                        <td>
                            <a href="<?=site_url($module['route'] .'/delete_attachment_detail/'. $y.'/'.$item_id.'/'.$type);?>" style="color: red" class="">
