  ...
  <div class="section-body">
    ...
    <div class="card">
      <div class="card-body no-padding">
        ...
        <div class="document-header force-padding">
          <div class="row">
            <div class="col-sm-6 col-lg-3">
              <div class="form-group">
                <div class="input-group">
                  <div class="input-group-content">
                    <input type="text" name="pr_number" id="pr_number" class="form-control" value="<?= $_SESSION['capex_closing']['document__number']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_doc_number'); ?>">
              ...
              <div class="form-group">
                <input type="text" name="date" id="date" data-provide="datepicker" data-date-format="yyyy-mm-dd" class="form-control" value="<?= $_SESSION['capex_closing']['date']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_date'); ?>" required>
            ...
            <div class="col-sm-12 col-lg-4">
              <div class="form-group">
                <select name="account" id="account" class="form-control" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_account'); ?>" required>
                  ...
                  <option value="<?= $key['coa'] ?>" <?= ($_SESSION['capex_closing']['account'] == $key['coa']) ? 'selected' : ''; ?>><?= $key['coa'] ?> - <?= $key['group'] ?></option>
                  <?php endforeach;?>
                </select>
              ...
              <div class="form-group">
                <textarea name="notes" id="notes" class="form-control" rows="3" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_notes'); ?>"><?= $_SESSION['capex_closing']['closing_notes']; ?></textarea>
                <label for="notes">Notes</label>
              </div>
            </div>
            <div class="col-sm-12 col-lg-4">
              <div class="form-group">
                <p class="form-control"><?= $_SESSION['capex_closing']['notes']; ?></p>
        ...
        <?php if (isset($_SESSION['capex_closing']['items'])) : ?>
          ...
          <div class="document-data table-responsive">
            <table class="table table-hover" id="table-document">
              ...
              <tbody>
                <?php foreach ($_SESSION['capex_closing']['items'] as $i => $items) : ?>
    ...
    $(buttonEditDocumentItem).on('click', function(e) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#capex_monthly_budget_id').val(response.capex_monthly_budget_id);
      ...
      success: function(resource) {
        $('#search_budget').autocomplete({
            ...
            select: function(event, ui) {
              ...
              $('#maximum_price').val(maximum_price);
              $('#mtd_budget').val(mtd_budget);
              $('#capex_monthly_budget_id').val(ui.item.capex_monthly_budget_id);
