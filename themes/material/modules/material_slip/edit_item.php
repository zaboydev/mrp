      ...
      <div class="col-sm-12">
        <div class="table-responsive">
          <table class="table table-hover table-bordered table-nowrap">
            ...
            <tbody>
              <?php foreach ($_SESSION['usage']['items'] as $id => $item) : ?>
                <tr id="row_<?= $id; ?>">
                    <td></td>
                    <td>
                        <?= $item['group']; ?>
                    ...
                    <td class="no-space">                        
                        <?php if (isset($_SESSION['usage']['id'])):?>
                    ...
                    <td>
                        <input type="number" max="<?= (isset($_SESSION['usage']['id']))? ($item['maximum_quantity']+$item['issued_quantity']):$_SESSION['usage']['items'][$id]['maximum_quantity']; ?>" rel="quantity" name="item[<?= $id; ?>][issued_quantity]" value="<?= $_SESSION['usage']['items'][$id]['issued_quantity']; ?>" class="form-control">
                    </td>
                    <td>
                        <input type="text" rel="remarks" name="item[<?= $id; ?>][remarks]" value="<?= $_SESSION['usage']['items'][$id]['remarks']; ?>" class="form-control">
                    </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
