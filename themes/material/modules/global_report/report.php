      ...
      <?=form_open(current_url(), array('autocomplete' => 'off', 'class' => 'form form-validate', 'id' => 'form-create-document'));?>
          <div class="card">
              <div class="card-head style-primary-dark">
                <header>budget - Purchase Order Report</header>
              </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-sm-12">
                      <div class="form-group">
                        <select name="selected_month" id="selected_month" class="form-control" data-input-type="autoset" data-source="<?=site_url('Global_Report/selected_month');?>" required>
                          <?php foreach(month() as $key=>$value):?>
                          <option value="<?=$key;?>" <?=($_SESSION['global_report']['month'] == $key) ? 'selected' : '';?>>
                            <?=$value;?>
                          </option>
                        <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-lg-12 col-sm-12">
                      <div class="form-group">
                        <select class="form-control input-sm" id="year" name="year" data-input-type="autoset" data-source="<?=site_url('Global_Report/selected_year');?>">
                          <?php foreach (budget_year() as $year):?>
                          <option value="<?=$year;?>" <?=($_SESSION['global_report']['year'] == $year) ? 'selected' : '';?>>
                            <?=$year;?>
                          </option>
                          <?php endforeach; ?>
                        </select>
                        <label for="selected_month">Year</label>                   
                      </div>
                    </div>                         
                </div>
                <div class="row">
