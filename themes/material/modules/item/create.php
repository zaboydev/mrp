      ...
      <div class="row">
        <div class="col-sm-12 col-lg-8">
          <div class="col-sm-6 col-lg-4">
            <!-- <div class="form-group">
              ...
              <?php foreach (available_item_groups(config_item('auth_inventory')) as $i => $group):?>
                <div class="radio">
                  <input type="radio" name="group" id="group_<?=$i;?>" value="<?=$group;?>" required>
                  <label for="group_<?=$i;?>">
                    <?=$group;?>
                  </label>
                </div>
          ...
          <div class="col-sm-6 col-lg-8">
            ...
            <div class="form-group">
                <input type="text" name="kode_stok" id="kode_stok" class="form-control">
                <label for="minimum_quantity">Kode Stok</label>
              </div>
            <div class="form-group">
                <input type="text" name="kode_pemakaian" id="kode_pemakaian" class="form-control">
