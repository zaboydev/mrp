            ...
            <div class="document-header force-padding">
                <div class="row">
                    <div class="col-sm-12 col-lg-4">
                        <input type="hidden" name="id" id="id" value="<?= $_SESSION['benefit_type']['id']; ?>">
                        <div class="form-group">
                            <input type="text" value="<?= $_SESSION['benefit_type']['benefit_type']; ?>" name="benefit_type" id="benefit_type" class="form-control" required>
                            <label for="benefit_type">Benefit Type</label>
                        </div>
                        <div class="form-group">
                            <input type="text" value="<?= $_SESSION['benefit_type']['notes']; ?>" name="notes" id="notes" class="form-control" required>
