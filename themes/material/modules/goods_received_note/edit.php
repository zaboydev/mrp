  ...
  <section class="has-actions style-default">
                    ...
                    <?php foreach ($_SESSION['receipt']['items'] as $i => $items):?>
                      <tr id="row_<?=$i;?>">
                        <td width="1">
                          ...
                          <!--tambahan-->
                          <a class="btn btn-icon-toggle btn-info btn-sm btn_edit_document_item" data-todo='{"id":<?=$items['id'];?>,"todo":<?=$i;?>}'>
            ...
            <div class="row">
                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                        <select name="group" id="group" data-tag-name="group" class="form-control input-sm" required>
                          ...
                          <?php foreach (available_item_groups($_SESSION['receipt']['category']) as $group):?>
                            <option value="<?=$group;?>">
                              <?=$group;?>
                            </option>
                          <?php endforeach;?>
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <fieldset>
                      ...
                      <?php if (config_item('auth_role') == 'SUPERVISOR'):?>
                        <div class="form-group">
                          <input type="text" id="received_unit_value" class="form-control input-sm" name="received_unit_value" value="0">
                          <label for="received_unit_value">Price per Unit</label>
                        </div>
                      <?php else:?>
              ...
              <div class="col-sm-12 col-lg-4">
                <fieldset>
                  ...
                  <div class="form-group">
                    <input type="text" name="expired_date" id="expired_date" data-tag-name="expired_date" class="form-control input-sm">
                ...
                <div class="row">
                  <div class="col-sm-6 col-lg-8">
                    <fieldset>
                      ...
                      <div class="form-group">
                        <input type="text" name="serial_number" id="edit_serial_number" class="form-control input-sm input-autocomplete" data-source="<?=site_url($module['route'] .'/search_items_by_serial/');?>" readonly>
                        <label for="serial_number">Serial Number</label>
                      </div>

                      <div class="form-group">
                        <input type="text" name="part_number" id="edit_part_number" class="form-control input-sm input-autocomplete" data-source="<?=site_url($module['route'] .'/search_items_by_part_number/');?>" readonly>
                        <label for="part_number">Part Number</label>
                      </div>
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <fieldset>
                      ...
                      <div class="form-group">
                        <input type="text" name="received_quantity" id="edit_received_quantity" data-tag-name="received_quantity" class="form-control input-sm" value="1" required>
                        <label for="received_quantity">Quantity</label>
                      </div>
                      ...
                      <div class="form-group">
                        <!-- <select name="unit" id="edit_unit" class="form-control input-sm">
                          <?php //foreach (available_units() as $key => $unit):?>
                            <option value="<?=$unit;?>"><?=$unit;?></option>
                          <?php //endforeach;?>
                        </select> -->
                        <input type="text" name="unit" id="edit_unit" data-tag-name="unit" data-search-for="unit" data-source="<?=site_url($modules['ajax']['route'] .'/search_item_units/');?>" class="form-control input-sm" required>
                        <label for="unit">Unit</label>
                      </div>

                      <?php if (config_item('auth_role') == 'SUPERVISOR'):?>
                        <div class="form-group">
                          <input type="text" id="edit_received_unit_value" class="form-control input-sm" name="received_unit_value" value="0">
                          <label for="received_unit_value">Price per Unit</label>
                        </div>
                      <?php else:?>
                        <input type="hidden" id="edit_received_unit_value" name="received_unit_value" value="0">
                      <?php endif;?>
    ...
    <div class="section-action style-default-bright">
      <div class="section-floating-action-row">
        <a class="btn btn-floating-action btn-lg btn-danger btn-tooltip ink-reaction" id="btn-submit-document" href="<?=site_url($module['route'] .'/save_edit');?>">
