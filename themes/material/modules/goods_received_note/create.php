                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                              <input type="text" name="unit_pakai" id="unit_pakai" data-tag-name="unit" data-search-for="unit" data-source="<?=site_url($modules['ajax']['route'] .'/search_item_units/');?>" class="form-control input-sm">                              
                            </div>
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                              
                              <input type="text" id="qty_konversi" class="form-control input-sm" name="qty_konversi" value="0" readonly="readonly"> 
                            </div>                     
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-3 col-sm-3 col-xs-3">
                            ...
                            <input type="text" name="unit_terima" id="unit_terima" data-tag-name="unit" data-search-for="unit" data-source="<?=site_url($modules['ajax']['route'] .'/search_item_units/');?>" class="form-control input-sm" placeholder="Unit" readonly>                            
                          </div>
                          <div class="col-lg-3 col-sm-3 col-xs-3">
                            <input type="text" id="isi" class="form-control input-sm" name="isi" value="0">                         
                          </div>
                          <div class="col-lg-3 col-sm-3 col-xs-3">
                  ...
                  <div class="col-sm-6 col-lg-6">
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                              ...
                              <input type="text" id="edit_qty_konversi" class="form-control input-sm" name="qty_konversi" value="0" readonly="readonly"> 
                            </div>                     
                          </div>
                          <label for="kurs">Unit Pakai</label>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-lg-3 col-sm-3 col-xs-3">
                            <input type="text" name="satuan" id="edit_satuan" data-tag-name="received_quantity" class="form-control input-sm" value="1" readonly="readonly">                            
                          </div>
                          <div class="col-lg-3 col-sm-3 col-xs-3">
                            
                            <input type="text" name="unit_terima" id="edit_unit_terima" data-tag-name="unit" data-search-for="unit" data-source="<?=site_url($modules['ajax']['route'] .'/search_item_units/');?>" class="form-control input-sm" placeholder="Unit" readonly>                            
                          </div>
                          <div class="col-lg-3 col-sm-3 col-xs-3">
  ...
  $(buttonEditDocumentItem).on('click', function(e){
    ...
    $.ajax({
      ...
      { 
        ...
        $('[id="edit_unit_terima"]').val(response.received_unit);
