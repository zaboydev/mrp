...
<?php startblock('actions_right') ?>
  <?php if (is_granted($modules['shipping_document_receipt'], 'index')):?>
  ...
  <div class="section-floating-action-row">
    <?php if (is_granted($modules['shipping_document_receipt'], 'index')):?>
      <a href="<?=site_url($modules['shipping_document_receipt']['route']);?>" class="btn btn-floating-action btn-danger btn-tooltip ink-reaction">
        <i class="md md-file-download"></i>
        <small class="top right"><?=$modules['shipping_document_receipt']['label'];?></small>
      </a>
    <?php endif ?>
...
<?php startblock('datafilter') ?>
  <div class="form force-padding">
    <div class="form-group">
      <label for="filter_received_date">Sent Date</label>
      <input class="form-control input-sm filter_daterange" data-column="2" id="filter_received_date">
    </div>
    ...
    <div class="form-group">
      <label for="filter_quantity">Received Status</label>
