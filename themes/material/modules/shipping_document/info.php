<div class="card card-underline style-default-bright">
          ...
          <table class="table table-striped table-nowrap">
            <thead id="table_header">
              <tr>
                ...
                <th>S/N</th>
                <th>Condition</th>
                <th class="text-center" colspan="2">Sent Quantity</th>                
                <th class="text-center" colspan="2">Unit Value</th>
                <th>AWB Number</th>
                <th>Remark</th>
              </tr>
            </thead>
  ...
  <div class="card-foot">
    ...
    ?>
    <?php if (is_granted($module, 'delete') && empty($entity['received_by']) && $entity['issued_date'] >= $data):?>
    ...
    <div class="pull-right">
      <?php if (is_granted($module, 'document') && empty($entity['received_by']) && $entity['issued_date'] >= $data):?>
