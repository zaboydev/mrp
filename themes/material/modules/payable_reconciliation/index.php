                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-3">
                                            <div class="form-group">
                                                <input class="form-control input-sm" data-column="2" id="date" data-provide="datepicker" data-date-format="yyyy-mm-dd">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            <div class="form-group">
                                                <select id="method_select" class="form-control">
                                                    <option value="PO">PO Date</option>
                                                    <option value="GRN">GRN Date</option>
                                                </select>
                                                <label for="currency">Aging Method</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-3">
                                            <div class="form-group">
...
<script>
    ...
    function getPo() {
        ...
        $.ajax({
            type: "POST",
            url: '<?= base_url() . "payable_reconciliation_summary/getPo" ?>',
            data: {
                'currency': currency,
                'vendor': suplier,
                'date': date,
    ...
    function get_po_for_print() {
        ...
        var urlPrint = '<?= base_url() ?>' + 'payable_reconciliation_summary/get_po_for_print/' + tipe + '/' + currency + '/' + suplier + '/' + method + '/' + date;
