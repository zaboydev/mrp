    ...
    <?php if (is_granted($module, 'create')) : ?>
        <div class="btn-group dropup">
            <button type="button" class="btn btn-floating-action btn-lg btn-danger btn-tooltip ink-reaction" id="btn-create-document" data-toggle="dropdown">
                <i class="md md-add"></i>
                <small class="top right">Add</small>
            </button>

            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                <li>
                    <a href="<?= site_url($module['route'] . '/create/remove'); ?>">Remove Part</a>
                </li>
                <li>
                    <a href="<?= site_url($module['route'] . '/create/install_remove'); ?>">Install & Remove Part</a>
                </li>
            </ul>
        </div>
    <?php endif ?>
