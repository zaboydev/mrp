...
<div class="section-floating-action-row">
    ...
    <!-- </div> -->
    <?php endif ?>
    <?php if (is_granted($module, 'create_component_status')) : ?>
        <a href="<?= site_url($module['route'] . '/create/COMPONENT STATUS'); ?>" class="btn btn-floating-action btn-lg btn-danger btn-tooltip ink-reaction" id="btn-create-document">
            <i class="md md-add"></i>
