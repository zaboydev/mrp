                ...
                <div class="col-sm-6 col-lg-5">
                  ...
                  <div class="">
                    <dl class="dl-inline">
                      ...
                      <dd><strong><font color="red">
                        : <?=number_format($entity['unit_value'],2);?>
                      </font></strong></dd>
                      <?php    
                        }
                      ?>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          <h3>Silahkan klik pilihan <strong><font color="green">APPROVED</font></strong> untuk menyetujui atau <strong><font color="red">REJECTED</font></strong> untuk menolak permintaan ini </h3>
                        </div>
                      </div>                      
                    </div>
                    <div class="row">
