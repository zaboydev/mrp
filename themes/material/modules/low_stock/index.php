...
<?php if (is_granted($module, 'document')) : ?>
  <div class="section-floating-action-row">
    <button type="button" data-source="<?= site_url('Purchase_Request' . '/create_item_purchase/'. $selected_category); ?>" class="btn btn-floating-action btn-lg btn-primary btn-tooltip ink-reaction" id="modal-approve-data-button-multi">
      <i class="md md-assignment"></i>
      <small class="top right">Create Request <?= $selected_category ?></small>
    </button>
