...
<div class="section-floating-action-row">
  <div class="btn-group dropup">
    ...
    <?php if (is_granted($module, 'document')) : ?>
      ...
      <a href="<?= site_url($module['route'] . '/create_2'); ?>" type="button" class="btn btn-floating-action btn-lg btn-danger btn-tooltip ink-reaction" id="btn-create-document">
        <i class="md md-add"></i>
        <small class="top right">Create <?= $module['label']; ?></small>
      </a>
    <?php endif ?>
