                  ...
                  <div class="row">
                    <div class="col-lg-5 col-sm-5">
                      <div class="form-group">
                        <input type="hidden" name="last_opname" id="last_opname" data-provide="datepicker" data-date-format="yyyy-mm-dd" class="form-control" placeholder="Start Date" value="<?=last_update();?>">
                        <input type="hidden" name="waktu" id="waktu" class="form-control" value="50">
                        <input type="text" name="opname_start_date" id="opname_start_date" data-provide="datepicker_opname" data-date-format="yyyy-mm-dd" class="form-control" placeholder="Start Date" value="<?=$_SESSION['opname']['opname_end_date'];?>" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_opname_start_date');?>" required>                   
                      </div>
                    </div> 
