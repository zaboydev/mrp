...
<?php if (is_granted($module, 'create')):?>
  <?php startblock('actions_right') ?>
    ...
    <div class="section-floating-action-row">      
        <a href="<?=site_url($module['route'] .'/index_cancel');?>" class="btn btn-floating-action btn-danger btn-tooltip ink-reaction">
          <i class="md md-file-download"></i>
          <small class="top right">Cancel Stock Opname Report</small>
        </a>
      
      <div class="btn-group dropup">
        <a href="<?=site_url($module['route'] .'/cancel_stock_opname');?>" type="button" class="btn btn-floating-action btn-lg btn-danger btn-tooltip ink-reaction">
          <i class="fa fa-times"></i>
          <small class="top right">Close Period Operation</small>          
        </a>
      </div>
      <div class="btn-group dropup">
        <a href="<?=site_url($module['route'] .'/create_stock_opname');?>" type="button" class="btn btn-floating-action btn-lg btn-primary btn-tooltip ink-reaction">
...
<?php if (is_granted($module, 'create_opname')):?>
  <?php startblock('actions_right') ?>

    <div class="section-floating-action-row">
      <div class="btn-group dropup">
        <a href="<?=site_url($module['route'] .'/create_opname');?>" type="button" class="btn btn-floating-action btn-lg btn-primary btn-tooltip ink-reaction">
          <i class="md md-restore"></i>
          <small class="top right">Close Period Operation</small>          
        </a>        
      </div>
...
<?php startblock('datafilter') ?>
  <form method="post" class="form force-padding">
    ...
    <input type="hidden" name="end_date" id="end_date" class="form-control">
    <div class="form-group">
      <label for="condition">Periode</label>
      <select class="form-control input-sm" id="periode" name="periode">
        <?php foreach (periode_opname() as $periode_opname):?>
          <option end-date="<?=$periode_opname['end_date'];?>" value="<?=$periode_opname['start_date'];?>" <?=($periode_opname['start_date'] == $selected_periode) ? 'selected' : '';?>>
