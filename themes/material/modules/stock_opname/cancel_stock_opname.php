                  ...
                  <div class="row">
                    <div class="col-lg-5 col-sm-5">
                      <div class="form-group">
                        <input type="text" name="opname_start_date" id="opname_start_date" class="form-control" placeholder="Start Date" value="<?=$_SESSION['cancel_opname']['opname_start_date'];?>" readonly>                   
                      </div>
                    </div> 
                    ...
                    <div class="col-lg-5 col-sm-5">
                      <div class="form-group">
                        <input type="text" name="opname_end_date" id="opname_end_date" class="form-control" placeholder="End Date" value="<?=$_SESSION['cancel_opname']['opname_end_date'];?>" readonly>   
                      </div>
                    </div>                           
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <a href="<?=site_url($module['route'] .'/cancel_opname_stock');?>" class="btn btn-block btn-primary ink-reaction" id="btn-submit-document">
                        Cancel Stock Opname
                      </a>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <a class="btn btn-block btn-danger ink-reaction" id="cancel-btn">
                        Back
                      </a>
                    </div>
                  </div>
