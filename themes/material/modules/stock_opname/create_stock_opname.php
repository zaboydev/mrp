                  ...
                  <div class="row">
                    <div class="col-lg-5 col-sm-5">
                      <div class="form-group">
                        <input type="text" name="last_opname" id="last_opname" data-provide="datepicker_opname" data-date-format="yyyy-mm-dd" class="form-control" placeholder="Start Date" value="<?=last_update();?>">
