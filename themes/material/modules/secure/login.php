    ...
    <div class="row">
        ...
        <form id="form_search" class="form-search form-inline" method="get" action="<?=site_url('search');?>">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <div class="input-group-addon" id="search-button">SEARCH</div>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-5 color-white">
        <?php if( ! isset( $on_hold_message ) ):?>
          ...
          <?=form_open(site_url('secure/authentication'), array('class' => 'form-signin'));?>

          <?php
          if ( $this->input->get('logout') )
            render_alert('You have successfully logged out.');

          if ( $this->input->get('failed') )
            render_alert('Username/Email/Password is not match, or user has banned!', 'danger');
