      ...
      <div class="col-sm-8 col-lg-9">
        <div class="row">
          <div class="col-sm-12 col-lg-6">
            ...
            <div class="form-group">
              <input type="text" name="coa" id="coa" class="form-control" autofocus data-validation-rule="unique" data-validation-exception="<?= $entity['coa']; ?>" value="<?= $entity['coa']; ?>" required>
