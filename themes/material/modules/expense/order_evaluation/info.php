                  ...
                  <?php if ($vendor['is_selected'] == 't') : ?>
                    <th class="middle-alignment text-left" colspan="3">
                      <?php if (is_granted($module, 'document') && $entity['status'] == 'approved') : ?>
                        <a href="<?= site_url('Expense_Purchase_Order/create_po/' . $vendor['id']); ?>" class="btn btn-tooltip btn-danger btn-sm ink-reaction">Create PO for <?= $vendor['vendor']; ?>
          ...
          <table class="table table-striped table-nowrap">
            ...
            <tfoot>
              <tr>
                ...
                <th><?=print_number(array_sum($total_qty_poe), 2);?></th>
