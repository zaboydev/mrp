            ...
            <div class="document-header force-padding">
                <div class="row">
                    <div class="col-sm-12 col-lg-4">
                        <input type="hidden" name="id" id="id" value="<?= $_SESSION['benefit_category']['id']; ?>">
                        <div class="form-group">
                            <input type="text" value="<?= $_SESSION['benefit_category']['benefit_code']; ?>" name="benefit_code" id="benefit_code" class="form-control" data-validation-rule="unique" data-validation-url="<?= site_url('ajax/expense_duty_name_validation'); ?>" data-validation-exception="" required>
                            <label for="benefit_code">Benefit Code</label>
                        </div>
                        <div class="form-group">
                            <input type="text" value="<?= $_SESSION['benefit_category']['benefit_name']; ?>" name="benefit_name" id="benefit_name" class="form-control" data-validation-rule="unique" data-validation-url="<?= site_url('ajax/expense_duty_name_validation'); ?>" data-validation-exception="" required>
                            <label for="benefit_name">Benefit Name</label>
                        </div>
                        <div class="form-group">
                            <select name="status" id="status" class="form-control" required>
                                <option value="AVAILABLE" <?= ("AVAILABLE" == $_SESSION['benefit_category']['status']) ? 'selected' : ''; ?>>AVAILABLE</option>
                                <option value="UNAVAILABLE" <?= ("UNAVAILABLE" == $_SESSION['benefit_category']['status']) ? 'selected' : ''; ?>>UNAVAILABLE</option>
                            </select>
                            <label for="benefit_code">Select Benefit Category</label>
                        </div>
                        <div class="form-group">
                            <input type="text" value="<?= $_SESSION['benefit_category']['notes']; ?>" name="notes" id="notes" class="form-control" data-validation-rule="unique" data-validation-url="<?= site_url('ajax/expense_duty_name_validation'); ?>" data-validation-exception="" required>
