  ...
  <section class="has-actions style-default">
                ...
                <table class="table table-hover" id="table-document">
                  ...
                  <tbody>
                    <?php foreach ($entity['items'] as $i => $items):?>
                      <?php if ($items['left_process_quantity'] > 0):?>
                      <tr id="row_<?=$i;?>">
                        <td>
                          <?=$items['group'];?>
                        </td>
                        ...
                        <td>
                          <?=number_format($items['issued_quantity']-$items['left_process_quantity'], 2);?>
                        </td>
                        <td>
                          <?=number_format($items['left_process_quantity'], 2);?>
                        </td>
                        <td>
                          <input type="number" name="items[<?=$items['id'];?>][received_quantity]" max="<?=$items['left_process_quantity'];?>" value="<?=$items['left_process_quantity'];?>" class="form-control input-sm" required>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="items[<?=$items['id'];?>][return_item_id]" value="<?=$items['id'];?>">
                            <input type="hidden" name="items[<?=$items['id'];?>][unit]" value="<?=$items['unit'];?>">
                            <input type="hidden" name="items[<?=$items['id'];?>][group]" value="<?=$items['group'];?>">
                        </td>
                        <td>
    ...
    <div class="section-action style-default-bright">
      <div class="section-floating-action-row">
        <a class="btn btn-floating-action btn-lg btn-danger btn-tooltip ink-reaction" id="btn-submit-document" href="<?=site_url($module['route'] .'/save_receive/'. $id);?>">
