...
<div class="section-floating-action-row">
  <?php if (is_granted($modules['inventory_purchase_order'], 'document')) : ?>
    <!-- <div class="btn-group dropup">
      <a type="button" href="<?= site_url($modules['inventory_purchase_order']['route'] . '/index_report'); ?>" class="btn btn-floating-action btn-md btn-info btn-tooltip ink-reaction">
    ...
    <div class="btn-group dropup">
      ...
      <ul class="dropdown-menu dropdown-menu-right" role="menu">
        <?php foreach (config_item('auth_inventory') as $category) : ?>
          <li>
            <a href="<?= site_url($modules['inventory_purchase_order']['route'] . '/create/' . $category); ?>"><?= $category; ?></a>
          </li>
        <?php endforeach; ?>
      </ul>
    </div>
  ...
  <?php endif; ?>
  <?php if (is_granted($modules['inventory_purchase_order'], 'order')) : ?>
    <!-- <div class="btn-group dropup">
...
<script>
  ...
  $(function() {
    ...
    <?php
    if (is_granted($modules['inventory_purchase_order'], 'approval')) {
      ?>
