        ...
        <div class="document-header force-padding">
          <div class="row">
              ...
              <div class="form-group">
                <div class="input-group">
                  <div class="input-group-content">
                    <input type="text" name="order_number" id="order_number" class="form-control" value="<?= $_SESSION['inventory']['order_number']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_doc_number'); ?>" readonly>
                    <label for="order_number">Document No.</label>
                  </div>
                  <span class="input-group-addon"><?= request_format_number($_SESSION['inventory']['cost_center_code']); ?></span>
                </div>
              </div>

              <div class="form-group">
                <input type="text" name="required_date" id="required_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" class="form-control" value="<?= $_SESSION['inventory']['required_date']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_required_date'); ?>" required>
            ...
            <div class="col-sm-12 col-lg-5">
              <div class="form-group">
                <input type="text" name="suggested_supplier" id="suggested_supplier" class="form-control" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_suggested_supplier'); ?>" value="<?= $_SESSION['inventory']['suggested_supplier']; ?>" required>
