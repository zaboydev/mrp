  ...
  <div class="section-body">
    ...
    <div class="card">
      ...
      <div class="card-body no-padding">
        ...
        <div class="document-header force-padding">
          <div class="row">
            <div class="col-sm-6 col-lg-3">
              <div class="form-group">
                <div class="input-group">
                  <div class="input-group-content">
                    <input type="text" name="document_number" id="document_number" class="form-control" maxlength="6" value="<?= $_SESSION['inventory_poe']['document_number']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_doc_number'); ?>" required>
              ...
              <div class="form-group">
                <input type="text" name="document_date" id="document_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-end-date="0d" class="form-control" value="<?= $_SESSION['inventory_poe']['document_date']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_document_date'); ?>" required>
                <label for="document_date">Date</label>
              </div>

              <div class="form-group">
                <input type="text" name="document_reference" id="document_reference" class="form-control" value="<?= $_SESSION['inventory_poe']['document_reference']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_document_reference'); ?>" required>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="form-group">
                <input type="text" name="created_by" id="created_by" class="form-control" value="<?= $_SESSION['inventory_poe']['created_by']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_created_by'); ?>" required>
                <label for="created_by">Created By</label>
              </div>

              <div class="form-group">
                <input type="text" name="approved_by" id="approved_by" class="form-control" value="<?= $_SESSION['inventory_poe']['approved_by']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_approved_by'); ?>" required>
              ...
              <div class="form-group hide">
                <select name="default_currency" id="default_currency" class="form-control" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_default_currency'); ?>" required>
                  <option value="USD" <?= ('USD' == $_SESSION['inventory_poe']['default_currency']) ? 'selected' : ''; ?>>USD (US Dolar)</option>
                  <option value="IDR" <?= ('IDR' == $_SESSION['inventory_poe']['default_currency']) ? 'selected' : ''; ?>>IDR (Indonesian Rupiah)</option>
                </select>
                <label for="default_currency">Currency</label>
              </div>

              <div class="form-group hide">
                <input type="number" name="exchange_rate" id="exchange_rate" class="form-control" value="<?= $_SESSION['inventory_poe']['exchange_rate']; ?>" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_exchange_rate'); ?>" required>
            ...
            <div class="col-sm-12 col-lg-5">
              <div class="form-group">
                <textarea name="notes" id="notes" class="form-control" rows="3" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_notes'); ?>"><?= $_SESSION['inventory_poe']['notes']; ?></textarea>
              ...
              <div class="form-group">
                <select name="approval" id="approval" class="form-control" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_default_approval'); ?>" required>
                  <option value="with_approval" <?= ('with_approval' == $_SESSION['inventory_poe']['approval']) ? 'selected' : ''; ?>>With Approval</option>
                  <option value="without_approval" <?= ('without_approval' == $_SESSION['inventory_poe']['approval']) ? 'selected' : ''; ?>>Without Approval</option>
                </select>
        ...
        <?php if (isset($_SESSION['inventory_poe']['request'])) : ?>
            ...
            <table class="table table-hover table-bordered">
              <thead>
                <tr>
                  ...
                  <?php foreach ($_SESSION['inventory_poe']['vendors'] as $key => $vendor) : ?>
                ...
                <tr>
                  <?php for ($v = 0; $v < count($_SESSION['inventory_poe']['vendors']); $v++) : ?>
                    <th class="middle-alignment text-center">Unit Price <span class="currency"><?= $_SESSION['inventory_poe']['vendors'][$v]['vendor_currency']; ?></span></th>
                    <th class="middle-alignment text-center">Core Charge <span class="currency"><?= $_SESSION['inventory_poe']['vendors'][$v]['vendor_currency']; ?></span></th>
                    <th class="middle-alignment text-center">Total Amount <span class="currency"><?= $_SESSION['inventory_poe']['vendors'][$v]['vendor_currency']; ?></span></th>
                  <?php endfor; ?>
                </tr>
              </thead>
              <tbody>
                <?php foreach ($_SESSION['inventory_poe']['request'] as $id => $request) : ?>
                  <tr id="row_<?= $id; ?>">
                    <td width="1">
                    ...
                    <?php $price = array(); ?>
                    <?php foreach ($_SESSION['inventory_poe']['vendors'] as $key => $vendor) : ?>
                      <?php $price[] = $_SESSION['inventory_poe']['request'][$id]['vendors'][$key]['total']; ?>
                    <?php endforeach; ?>
                    <?php $min = min($price); ?>
                    <?php foreach ($_SESSION['inventory_poe']['vendors'] as $key => $vendor) : ?>
                      <?php
                            if ($min == $_SESSION['inventory_poe']['request'][$id]['vendors'][$key]['total']) {
                            ...
                            ?>
                      <?php
                            if ($_SESSION['inventory_poe']['request'][$id]['vendors'][$key]['is_selected'] == 't') {
                      ...
                      <td style="<?= $style; ?>">
                        <?= anchor($module['route'] . '/set_selected_vendor/' . $id . '/' . $key, number_format($_SESSION['inventory_poe']['request'][$id]['vendors'][$key]['unit_price'], 2), 'style="color: black"'); ?>

                      </td>

                      <td style="<?= $style; ?>">
                        <?= number_format($_SESSION['inventory_poe']['request'][$id]['vendors'][$key]['core_charge'], 2); ?>
                      </td>

                      <td style="<?= $style; ?>">
                        <?= number_format($_SESSION['inventory_poe']['request'][$id]['vendors'][$key]['total'], 2); ?>
                      </td>
                    <?php endforeach; ?>
                  </tr>
                <?php endforeach; ?>
      ...
      <div class="card-actionbar">
        <div class="card-actionbar-row">
          <div class="pull-left">
            ...
            <?php if (!empty($_SESSION['inventory_poe']['request'])) : ?>
