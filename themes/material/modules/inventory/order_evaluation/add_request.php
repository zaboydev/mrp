          ...
          <table class="table table-hover" id="tbl_prl">
            ...
            <tbody>
              <?php foreach ($entities as $e => $entity) : ?>
                <?php if ($entity['quantity']-$entity['process_qty']>0) : ?>
                <tr>
                  <td>
                    <div class="checkbox">

                      <input type="checkbox" name="request_id[]" id="request_id_<?= $e; ?>" value="<?= $entity['id']; ?>" <?= (in_array($entity['id'], array_keys($_SESSION['inventory_poe']['request']))) ? 'checked' : ''; ?>>
