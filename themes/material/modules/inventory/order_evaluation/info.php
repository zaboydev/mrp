<div class="card card-underline style-default-bright">
                  ...
                  <?php if ($vendor['is_selected'] == 't') : ?>
                    <th class="middle-alignment text-left" colspan="3">
                      <?php if (is_granted($module, 'document') && $entity['status'] == 'approved') : ?>
                        <a href="<?= site_url('Inventory_Purchase_Order/create_po/' . $vendor['id']); ?>" class="btn btn-tooltip btn-danger btn-sm ink-reaction">Create PO for <?= $vendor['vendor']; ?>
  ...
  <div class="card-foot">
    <div class="pull-left">
      <?php if (is_granted($module, 'delete') && $entity['status'] == 'evaluation') : ?>
    ...
    <div class="pull-right">
      ...
      <?php if (is_granted($modules['purchase_order_evaluation'], 'document') && ($entity['status'] == 'evaluation' || $entity['status'] == 'rejected')) : ?>
