  ...
  <div class="card style-default-bright">
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            <input type="text" name="tanggal" id="tanggal" data-provide="datepicker" data-date-format="yyyy-mm-dd" class="form-control" value="<?=date('Y-m-d');?>">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            <input type="text" name="kurs_dollar" id="kurs_dollar" class="form-control" data-validation-exception="<?=$entity['kurs_dollar'];?>" value="<?=$entity['kurs_dollar'];?>">
