...
<div class="card style-default-bright">
          ...
          <div class="col-sm-12 col-lg-6">
            <div class="form-group">
              ...
              <?php foreach ($this->config->item('account_types') as $key => $value):?>
                <option value="<?= $value;?>" <?php if($entity['category']==$value):?> selected <?php endif;?>><?= $value;?></option>
              <?php endforeach;?>  
              </select>            
            </div>
            <div class="form-group">
              <input type="text" name="coa" id="coa" class="form-control" data-validation-rule="unique" data-validation-exception="" required value="<?= $entity['coa']; ?>">
              <label for="coa">Account Code</label>
            </div>

            <div class="form-group">
              <input type="text" name="group" id="group" class="form-control" data-validation-rule="unique" data-validation-exception="" required value="<?= $entity['group']; ?>">
  ...
  <div class="card-foot">
    ...
    <input type="hidden" name="group_exception" id="group_exception" value="<?= $entity['group']; ?>">
    <input type="hidden" name="coa_exception" id="coa_exception" value="<?= $entity['coa']; ?>">
