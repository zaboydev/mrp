        ...
        <div class="document-header force-padding">
          <div class="row">
            <div class="col-sm-6 col-lg-3">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <span class="input-group-addon" id="format_number"><?=payment_request_format_number($_SESSION['spd_payment']['type']);?></span>
                </div>
              </div>
            ...
            <div class="col-sm-12 col-lg-4">
              ...
              <div class="form-group">
                <textarea name="notes" id="notes" class="form-control" rows="2" data-input-type="autoset" data-source="<?= site_url($module['route'] . '/set_notes'); ?>"><?= $_SESSION['spd_payment']['closing_notes']; ?></textarea>
                ...
                <?php foreach ($_SESSION['spd_payment']['items'] as $i => $item) : ?>
                  ...
                  <tr id="row_<?= $i; ?>">
                    ...
                    <td>
                      ...
                      <input name="account_code[]" id="account_code_<?= $i ?>" type="text" class="form-control-payment" value="<?=$item['account_code']?>">
