...
<div class="section-floating-action-row">
  <div class="btn-group dropup">
    <?php if (is_granted($module, 'create')) : ?>
      <a href="<?= site_url($module['route'] . '/create/spd'); ?>" type="button" class="btn btn-floating-action btn-lg btn-danger btn-tooltip ink-reaction" id="btn-create-document">
        <i class="md md-add"></i>
      ...
      <script>
        ...
        $(function() {
          ...
          function getAttachment(id) {
            $.ajax({
              type: "GET",
              url: 'spd_payment/listAttachment/' + id,
              cache: false,
              success: function(response) {
                var data = jQuery.parseJSON(response)
                $("#listView").html("")
