  ...
  <div class="section-body">
    ...
    <div class="card">
      ...
      <div class="card-head style-primary-dark">
        <header><?= PAGE_TITLE_1; ?> <span id="Periode"></span> <span id="Base"></span> <span id="Category"></span> <span id="Vendor"></span> <span id="Source"></span></header>
    ...
    <div class="card">
      ...
      <?php startblock('page_head_2') ?>
      <div class="card-head style-primary-dark">
        <header><?= PAGE_TITLE_2; ?> <span id="Periode"></span> <span id="Base"></span> <span id="Category"></span> <span id="Vendor"></span> <span id="Source"></span></header>

        <?php emptyblock('page_head_tools_2') ?>
      </div>
      <?php endblock() ?>
