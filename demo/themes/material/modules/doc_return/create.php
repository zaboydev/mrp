            ...
            <div class="document-header force-padding">
              <div class="row">
                <div class="col-sm-12 col-lg-8">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <div class="input-group">
                          <div class="input-group-content">
                            <input type="text" name="document_number" id="document_number" class="form-control" maxlength="6" value="<?=$_SESSION['return']['document_number'];?>" data-source="<?=site_url($module['route'] .'/set_document_number');?>" data-input-type="autoset" autofocus required>
                      ...
                      <div class="form-group">
                        <input type="text" name="issued_by" id="issued_by" class="form-control" value="<?=$_SESSION['return']['issued_by'];?>" data-source="<?=site_url($module['route'] .'/set_document_issued_by');?>" data-input-type="autoset" required>
                        <label for="issued_by">Released/Issued By</label>
                      </div>

                      <div class="form-group">
                        <input type="text" name="approved_by" id="approved_by" class="form-control" value="<?=$_SESSION['return']['approved_by'];?>" data-source="<?=site_url($module['route'] .'/set_document_approved_by');?>" data-input-type="autoset" required>
                        <label for="approved_by">Approved By</label>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <input type="text" name="issued_date" id="issued_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-end-date="0d" class="form-control datepicker" value="<?=$_SESSION['return']['issued_date'];?>" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_document_issued_date');?>" data-input-type="autoset" required>
                        <label for="issued_date">Date of sent</label>
                      </div>

                      <div class="form-group">
                        <input type="text" name="sent_by" id="sent_by" class="form-control" value="<?=$_SESSION['return']['sent_by'];?>" data-source="<?=site_url($module['route'] .'/set_document_sent_by');?>" data-input-type="autoset" required>
                      ...
                      <div class="form-group">
                        ...
                        <select name="issued_to" id="issued_to" class="form-control" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_document_issued_to');?>">
                          <?php foreach (available_vendors(config_item('auth_inventory')) as $issued_to):?>
                            <option value="<?=$issued_to;?>" <?=($_SESSION['return']['issued_to'] == $issued_to) ? 'selected' : '';?>>
                              <?=$issued_to;?>
                            </option>
                          <?php endforeach;?>
                        </select>
                ...
                <div class="col-sm-12 col-lg-4">
                  <div class="form-group">
                    <textarea name="notes" id="notes" class="form-control" rows="4" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_document_notes');?>"><?=$_SESSION['return']['notes'];?></textarea>
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="form-group">
                  <div class="input-group">
                    <div class="input-group-content">
                      <input type="text" id="search_available_stock" data-search-for="available_stock" class="form-control" data-source="<?=site_url($modules['ajax']['route'] .'/get_available_stock/'. config_item('auth_warehouse') .'/'. $_SESSION['return']['category']);?>">
