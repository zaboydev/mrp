    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <div class="form-group">
            <input type="password" class="form-control" name="passconf" id="passconf" data-toggle="tooltip" data-placement="top" data-trigger="focus" data-original-title="this input must match with password above" disabled>
