            ...
            <div class="document-header force-padding">
              <div class="row">
                <div class="col-sm-6 col-lg-3">
                  ...
                  <div class="form-group">
                    <input type="text" name="issued_date" id="issued_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-end-date="0d" class="form-control" value="<?=$_SESSION['shipment']['issued_date'];?>" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_issued_date');?>" required>
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="form-group">
                    <select name="issued_to" id="issued_to" class="form-control" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_issued_to');?>" required>
                      ...
                      <?php foreach (available_warehouses(config_item('auth_warehouse')) as $w => $warehouse):?>
      ...
      success: function (resource) {
        $('#search_stock_in_stores').autocomplete({
          ...
          select: function( event, ui ) {
            ...
            $('input[id="issued_quantity"]').attr('data-rule-max', ui.item.quantity).attr('data-msg-max', 'max available '+ ui.item.quantity);
