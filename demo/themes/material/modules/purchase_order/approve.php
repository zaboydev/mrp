        ...
        <div class="document-header force-padding">
          <div class="row">
            <div class="col-sm-6 col-lg-3">
              <div class="form-group">
                <div class="input-group">
                  <div class="input-group-content">
                    ...
                    <input type="text" name="document_number" id="document_number" class="form-control" maxlength="6" value="<?=$entity['document_number'];?>" required>
              ...
              <div class="form-group">
                <input type="text" name="checked_by" id="checked_by" class="form-control" value="<?=$entity['checked_by'];?>">
                <label for="checked_by">Checked By</label>
              </div>

              <div class="form-group">
                <input type="text" name="known_by" id="known_by" class="form-control" value="<?=$entity['known_by'];?>">
                <label for="known_by">Approved (HOS)</label>
              </div>

              <div class="form-group">
                <input type="text" name="approved_by" id="approved_by" class="form-control" value="<?=$entity['approved_by'];?>">
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="form-group">
                <input type="text" name="deliver_company" id="deliver_company" class="form-control" value="<?=$entity['deliver_company'];?>" required>
