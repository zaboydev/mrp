      ...
      <div class="btn-group dropup">
        ...
        <ul class="dropdown-menu dropdown-menu-right" role="menu">
          <?php foreach (config_item('auth_inventory') as $category):?>
            <li>
              <a href="<?=site_url($modules['purchase_order_evaluation']['route'] .'/create/'. $category);?>"><?=$category;?></a>
            </li>
          <?php endforeach;?>
        </ul>
      </div>
...
<?php startblock('datafilter') ?>
  <div class="form force-padding">
    ...
    <div class="form-group">
      ...
      <select class="form-control input-sm filter_dropdown" data-column="0" id="filter_status">
    ...
    <div class="form-group">
      ...
      <select class="form-control input-sm filter_dropdown" data-column="8" id="filter_vendor">
        <option value="">
          Not filtered
        </option>
