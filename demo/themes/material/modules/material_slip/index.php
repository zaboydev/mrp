...
<?php startblock('datafilter') ?>
  <div class="form force-padding">
    <div class="form-group">
      ...
      <input class="form-control input-sm filter_daterange" data-column="2" id="filter_issued_date" readonly>
    </div>
    ...
    <div class="form-group">
      <label for="filter_issued_to">Issued to</label>
      <input type="text" class="form-control input-sm filter_numeric_text" data-column="12" id="filter_issued_to">
    </div>
  </div>
<?php endblock()?>
