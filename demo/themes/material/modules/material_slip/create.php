            ...
            <div class="document-header force-padding">
              <div class="row">
                <div class="col-sm-6 col-lg-3">
                  ...
                  <div class="form-group">
                    <input type="text" name="issued_date" id="issued_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-end-date="0d" class="form-control" value="<?=$_SESSION['usage']['issued_date'];?>" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_issued_date');?>" required>
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="form-group">
                    <input type="text" name="issued_to" id="issued_to" class="form-control" value="<?=$_SESSION['usage']['issued_to'];?>" data-input-type="autoset" data-source="<?=site_url($module['route'] .'/set_issued_to');?>" required>
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <label for="maximum_quantity">Stock</label>
                      </div>
                      ...
                      <?php if (config_item('auth_role') == 'SUPERVISOR'):?>
                        <div class="form-group">
                          ...
                          <label for="issued_unit_value">Unit</label>
                        </div>
                      <?php else:?>
