            ...
            <div class="document-header force-padding">
              <div class="row">
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="form-group">
                    <input type="text" name="received_date" id="received_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-end-date="0d" class="form-control" value="<?=date('Y-m-d');?>" required>
                  ...
                  <tbody>
                    <?php foreach ($entity['items'] as $i => $items):?>
                      <tr id="row_<?=$i;?>">
                        ...
                        <td>
                          <input type="number" name="items[<?=$items['id'];?>][received_quantity]" value="<?=$items['issued_quantity'];?>" class="form-control input-sm" required>
                        </td>
                        <td>
