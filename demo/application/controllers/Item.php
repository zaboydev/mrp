  ...
  public function save()
  {
    ...
    if (is_granted($this->module, 'save') === FALSE){
      ...
      if ($this->input->post('id')){
        if ($this->model->isItemExists($this->input->post('part_number'), NULL, $this->input->post('part_number_exception'))){
          $return['type'] = 'danger';
        ...
        if ($this->model->isItemExists($this->input->post('part_number'))){
          $return['type'] = 'danger';
          $return['info'] = 'Duplicate Part Number! Part Number '. $this->input->post('part_number') .' already exists.';
        } else {
