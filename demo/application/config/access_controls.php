...
$config['access_control']['stock'] = array(
  'index'         => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'in_stores'     => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'low_stock'     => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'in_use'        => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'on_delivery'   => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'on_shipping'   => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'on_return'     => 'PIC STOCK,OTHER,PIC PROCUREMENT',
);

$config['access_control']['stock'] = array(
  'index'         => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'stock_general' => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'low_stock'     => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'import'        => 'PIC STOCK',
...
$config['access_control']['purchase_request'] = array(
  ...
  'import'    => 'PIC STOCK',
  'edit'      => 'PIC STOCK',
  'show'      => 'PIC STOCK,OTHER,PIC PROCUREMENT',
  'budget'    => 'PIC STOCK',
);
