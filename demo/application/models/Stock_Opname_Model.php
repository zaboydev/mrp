...
class Stock_Opname_Model extends MY_Model
{
  ...
  public function getIndex($period_month, $period_year, $condition = "SERVICEABLE", $warehouse = NULL, $category = NULL, $return = 'array')
  {
  ...
  public function countIndexFiltered($period_month, $period_year, $condition = "SERVICEABLE", $warehouse = NULL, $category = NULL)
  {
    $this->db->select(array_keys($this->getSelectedColumns()));
    $this->db->from('tb_stock_in_stores_reports');
    $this->db->join('tb_master_items', 'tb_master_items.id = tb_stock_in_stores_reports.item_id');
  ...
  public function countIndex($period_month, $period_year, $condition = "SERVICEABLE", $warehouse = NULL, $category = NULL)
  {
    $this->db->select(array_keys($this->getSelectedColumns()));
    $this->db->from('tb_stock_in_stores_reports');
    $this->db->join('tb_master_items', 'tb_master_items.id = tb_stock_in_stores_reports.item_id');
