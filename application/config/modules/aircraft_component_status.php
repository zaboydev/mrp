...
$config['module']['aircraft_component_status']['permission']      = array(
  'create'                  => 'PPC,MECHANIC,ADMIN,SUPER ADMIN',
  'edit'                    => 'PPC,MECHANIC,ADMIN,SUPER ADMIN',
  'info'                    => 'PPC,MECHANIC,ADMIN,SUPER ADMIN',
  'save'                    => 'PPC,MECHANIC,ADMIN,SUPER ADMIN',
  'delete'                  => 'PPC,ADMIN,SUPER ADMIN',
  'index'  	                => 'PPC,MECHANIC,ADMIN,SUPER ADMIN',
