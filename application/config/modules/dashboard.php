...
$config['module']['dashboard']['permission'] = array(
  'index' => 'ADMIN,PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,SUPER ADMIN,FINANCE MANAGER,OPERATION SUPPORT,CHIEF OPERATION SUPPORT',
