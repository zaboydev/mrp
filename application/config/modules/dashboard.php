...
$config['module']['dashboard']['permission'] = array(
  'index' => 'PROCUREMENT MANAGER,AP STAFF,TELLER,ADMIN,PROCUREMENT,PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,SUPER ADMIN,FINANCE MANAGER,OPERATION SUPPORT,CHIEF OPERATION OFFICER,BUDGETCONTROL,PIC STAFF',
  'approval' => 'PROCUREMENT MANAGER,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE MANAGER,SUPER ADMIN,VP FINANCE,OPERATION SUPPORT,CHIEF OPERATION OFFICER,BUDGETCONTROL'
);
