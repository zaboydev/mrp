...
$config['module']['dashboard']['permission'] = array(
  ...
  'approval' => 'ASSISTANT HOS,PROCUREMENT MANAGER,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE MANAGER,SUPER ADMIN,VP FINANCE,OPERATION SUPPORT,CHIEF OPERATION OFFICER,BUDGETCONTROL,OTHER'
);
