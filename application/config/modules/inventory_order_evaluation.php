...
$config['module']['inventory_order_evaluation']['permission']     = array(
  ...
  'print'     => 'AP STAFF,SUPER ADMIN,PROCUREMENT,PIC PROCUREMENT,PROCUREMENT MANAGER,FINANCE,FINANCE MANAGER,CHIEF OPERATION OFFICER,CHIEF OF FINANCE,HEAD OF SCHOOL,VP FINANCE',
