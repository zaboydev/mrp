...
$config['module']['purchase_request']['permission']     = array(
  ...
  'print'     => 'PROCUREMENT,PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,OPERATION SUPPORT,CHIEF OPERATION OFFICER,FINANCE MANAGER,HEAD OF SCHOOL,CHIEF OF FINANCE',
