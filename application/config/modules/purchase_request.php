...
$config['module']['purchase_request']['permission']     = array(
  ...
  'print'     => 'PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,OPERATION SUPPORT',
  'approval'  => 'CHIEF OF MAINTANCE,FINANCE MANAGER,SUPER ADMIN,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,OPERATION SUPPORT',
);
