...
$config['module']['purchase_request']['permission']     = array(
  'index'     => 'PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,CHIEF OF MAINTANCE,FINANCE MANAGER',
  'info'      => 'PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,CHIEF OF MAINTANCE,FINANCE MANAGER',
  'document'  => 'PIC STOCK,SUPERVISOR,PIC PROCUREMENT,SUPER ADMIN',
  'print'     => 'PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE',
  'approval'  => 'CHIEF OF MAINTANCE,FINANCE MANAGER,SUPER ADMIN',
);
