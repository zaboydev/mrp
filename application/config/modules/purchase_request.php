...
$config['module']['purchase_request']['permission']     = array(
  ...
  'document'  => 'PIC STOCK,SUPERVISOR,PIC PROCUREMENT,SUPER ADMIN,CHIEF OF MAINTANCE',
  'print'     => 'PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,CHIEF OF MAINTANCE',
);
