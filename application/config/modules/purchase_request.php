...
$config['module']['purchase_request']['permission']     = array(
  'index'     => 'PROCUREMENT,PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,CHIEF OF MAINTANCE,FINANCE MANAGER,OPERATION SUPPORT',
  'info'      => 'PROCUREMENT,PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,CHIEF OF MAINTANCE,FINANCE MANAGER,OPERATION SUPPORT',
  'document'  => 'PIC STOCK,SUPERVISOR,SUPER ADMIN',
  'print'     => 'FINANCE SUPERVISOR,AP STAFF,PROCUREMENT,PIC PROCUREMENT,PIC STOCK,SUPERVISOR,FINANCE,OTHER,VP FINANCE,SUPER ADMIN,OPERATION SUPPORT,CHIEF OPERATION OFFICER,FINANCE MANAGER,HEAD OF SCHOOL,CHIEF OF FINANCE',
  'approval'  => 'CHIEF OF MAINTANCE,FINANCE MANAGER,OPERATION SUPPORT',
  'closing'   => 'SUPER ADMIN,PROCUREMENT',
  'manage_attachment' => 'PIC STOCK,SUPERVISOR,SUPER ADMIN',
);
