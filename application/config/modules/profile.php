...
$config['module']['profile']['permission']  = array(
    'index'   => 'REIMBURSEMENT,PPC,HR STAFF,MECHANIC,FINANCE SUPERVISOR,PIC STAFF JKT,HEAD DEPT UNIQ JKT,PIC STAFF UNIQ JKT,OTHER,FINANCE,VP FINANCE,ADMIN,SUPERVISOR,PIC STOCK,PIC PROCUREMENT,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,PROCUREMENT,SUPER ADMIN,FINANCE MANAGER,OPERATION SUPPORT,CHIEF OPERATION OFFICER,AP STAFF,TELLER,BUDGETCONTROL,PIC STAFF,PROCUREMENT MANAGER,ASSISTANT HOS',
    ...
    'info'    => 'REIMBURSEMENT,ADMIN,SUPER ADMIN,HR MANAGER,HR STAFF',
