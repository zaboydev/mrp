...
$config['module']['master_expense_reimbursement']['name']        = 'expensereimbursement';
$config['module']['master_expense_reimbursement']['route']       = 'expensereimbursement';
$config['module']['master_expense_reimbursement']['view']        = config_item('module_path') .'expensereimbursement/';
