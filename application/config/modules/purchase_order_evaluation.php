...
$config['module']['purchase_order_evaluation']['permission']     = array(
  ...
  'print'     => 'PIC PROCUREMENT,SUPERVISOR,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE,PROCUREMENT,SUPER ADMIN,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE',
);
