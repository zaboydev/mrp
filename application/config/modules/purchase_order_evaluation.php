...
$config['module']['purchase_order_evaluation']['permission']     = array(
  'index'     => 'PIC PROCUREMENT,CHIEF OF MAINTANCE,FINANCE,PROCUREMENT,SUPER ADMIN,PROCUREMENT MANAGER',
  'info'      => 'PIC PROCUREMENT,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE,PROCUREMENT,SUPER ADMIN,PROCUREMENT MANAGER',
  'document'  => 'PIC PROCUREMENT,PROCUREMENT,SUPER ADMIN,PROCUREMENT MANAGER',
  'approval'  => 'CHIEF OF MAINTANCE,SUPER ADMIN',
  'print'     => 'FINANCE SUPERVISOR,AP STAFF,PIC PROCUREMENT,SUPERVISOR,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE,PROCUREMENT,SUPER ADMIN,VP FINANCE,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,CHIEF OPERATION OFFICER,PROCUREMENT MANAGER',
);
