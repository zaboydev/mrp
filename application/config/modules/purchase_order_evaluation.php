...
$config['module']['purchase_order_evaluation']['permission']     = array(
  ...
  'print'     => 'PIC PROCUREMENT,SUPERVISOR,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE,PROCUREMENT,SUPER ADMIN,VP FINANCE,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,CHIEF OPERATION OFFICER',
);
