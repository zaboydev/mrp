...
$config['module']['purchase_order_evaluation']['permission']     = array(
  'index'     => 'PIC PROCUREMENT,SUPERVISOR,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE,PROCUREMENT',
  'info'      => 'PIC PROCUREMENT,SUPERVISOR,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE,PROCUREMENT',
  'document'  => 'PIC PROCUREMENT,SUPERVISOR,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE,PROCUREMENT',//tambahan supervisor semua permission
  'approval'  => 'CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE',
  'print'     => 'PIC PROCUREMENT,SUPERVISOR,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE,PROCUREMENT',
);
