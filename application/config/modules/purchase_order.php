...
$config['module']['purchase_order']['permission']     = array(
  'index'     => 'PIC PROCUREMENT,FINANCE,OTHER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,PROCUREMENT,SUPERVISOR,SUPER ADMIN,FINANCE MANAGER,CHIEF OPERATION SUPPORT',
  'info'      => 'PIC PROCUREMENT,FINANCE,OTHER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,PROCUREMENT,SUPERVISOR,SUPER ADMIN,FINANCE MANAGER,CHIEF OPERATION SUPPORT',
  'print'     => 'PIC PROCUREMENT,FINANCE,OTHER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,PROCUREMENT,SUPER ADMIN,CHIEF OPERATION SUPPORT',
  'document'  => 'PIC PROCUREMENT,PROCUREMENT,SUPERVISOR,SUPER ADMIN',//tambhan supervisor
  'payment'   => 'FINANCE,SUPER ADMIN',//tambhan supervisor
  'approval'  => 'FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,SUPER ADMIN,CHIEF OPERATION SUPPORT'
);
