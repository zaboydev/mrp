...
$config['module']['purchase_order']['permission']     = array(
  ...
  'print'     => 'AP STAFF,PIC PROCUREMENT,FINANCE,OTHER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,PROCUREMENT,SUPER ADMIN,CHIEF OPERATION OFFICER,FINANCE MANAGER',
