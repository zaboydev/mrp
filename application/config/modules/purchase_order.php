...
$config['module']['purchase_order']['permission']     = array(
  'index'     => 'PIC PROCUREMENT,FINANCE,OTHER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,PROCUREMENT,SUPERVISOR,SUPER ADMIN,FINANCE MANAGER',
  'info'      => 'PIC PROCUREMENT,FINANCE,OTHER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,PROCUREMENT,SUPERVISOR,SUPER ADMIN,FINANCE MANAGER',
  ...
  'approval'  => 'FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,SUPER ADMIN'
);
