...
$config['module']['item_serial']['permission']  = array(
  'index'     => 'ADMIN,PIC PROCUREMENT,PIC STOCK,SUPERVISOR,VP FINANCE',
  'create'    => 'ADMIN,PIC STOCK,SUPERVISOR,VP FINANCE',
  'show'      => 'ADMIN,PIC STOCK,PIC PROCUREMENT,OTHER,SUPERVISOR,VP FINANCE',
  'edit'      => 'ADMIN,PIC STOCK,SUPERVISOR,VP FINANCE',
  'import'    => 'ADMIN,PIC STOCK,SUPERVISOR,VP FINANCE',
  'delete'    => 'PIC STOCK,SUPERVISOR,VP FINANCE',
  );
