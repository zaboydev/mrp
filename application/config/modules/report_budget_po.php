...
$config['module']['report_budget_po']['permission']     = array(
  'index'     => 'PIC PROCUREMENT,FINANCE,CHIEF OF MAINTANCE,HEAD OF SCHOOL,CHIEF OF FINANCE,FINANCE MANAGER,SUPER ADMIN,VP FINANCE,OPERATION SUPPORT,CHIEF OPERATION OFFICER,PROCUREMENT',
  'info'      => 'PIC PROCUREMENT,FINANCE,VP FINANCE,SUPER ADMIN,FINANCE MANAGER,PROCUREMENT',
  'print'     => 'PIC PROCUREMENT,FINANCE,VP FINANCE,SUPER ADMIN,FINANCE MANAGER,PROCUREMENT',
  'document'  => 'PIC PROCUREMENT,HEAD OF SCHOOL,CHIEF OF FINANCE,SUPER ADMIN,FINANCE MANAGER,PROCUREMENT',//tambhan supervisor
