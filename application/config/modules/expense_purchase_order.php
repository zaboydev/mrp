...
$config['module']['expense_purchase_order']['permission']     = array(
  'index'     => 'FINANCE,ASSISTANT HOS,PROCUREMENT,PIC PROCUREMENT,SUPER ADMIN,PROCUREMENT MANAGER,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,CHIEF OF FINANCE',
  'info'      => 'FINANCE,ASSISTANT HOS,PROCUREMENT,PIC PROCUREMENT,SUPER ADMIN,PROCUREMENT MANAGER,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,CHIEF OF FINANCE',
  'print'     => 'FINANCE,FINANCE SUPERVISOR,AP STAFF,ASSISTANT HOS,PROCUREMENT,PIC PROCUREMENT,SUPER ADMIN,PROCUREMENT MANAGER,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,CHIEF OF FINANCE',
