...
$config['module']['capex_purchase_order']['permission']     = array(
  ...
  'print'     => 'AP STAFF,ASSISTANT HOS,PROCUREMENT,PIC PROCUREMENT,SUPER ADMIN,PROCUREMENT MANAGER,FINANCE MANAGER,VP FINANCE,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,CHIEF OF FINANCE',
