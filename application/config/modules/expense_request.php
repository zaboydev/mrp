...
$config['module']['expense_request']['permission']     = array(
  'index'     => 'SUPER ADMIN,BUDGETCONTROL,VP FINANCE,PIC STAFF,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,FINANCE MANAGER,CHIEF OF FINANCE,PIC PROCUREMENT',
  'info'      => 'SUPER ADMIN,BUDGETCONTROL,VP FINANCE,PIC STAFF,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,FINANCE MANAGER,CHIEF OF FINANCE,PIC PROCUREMENT',
  'print'     => 'SUPER ADMIN,BUDGETCONTROL,VP FINANCE,PIC STAFF,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,FINANCE MANAGER,CHIEF OF FINANCE,PIC PROCUREMENT',
  'document'  => 'SUPER ADMIN,PIC STAFF',
  'approval'  => 'BUDGETCONTROL,VP FINANCE,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,FINANCE MANAGER,CHIEF OF FINANCE'
);
