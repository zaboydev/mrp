...
$config['module']['expense_request']['permission']     = array(
  'index'     => 'HEAD DEPT UNIQ JKT,PIC STAFF UNIQ JKT,AP STAFF,SUPER ADMIN,BUDGETCONTROL,VP FINANCE,PIC STAFF,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,FINANCE MANAGER,CHIEF OF FINANCE,PIC PROCUREMENT,ASSISTANT HOS',
  'info'      => 'HEAD DEPT UNIQ JKT,PIC STAFF UNIQ JKT,AP STAFF,SUPER ADMIN,BUDGETCONTROL,VP FINANCE,PIC STAFF,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,FINANCE MANAGER,CHIEF OF FINANCE,PIC PROCUREMENT,ASSISTANT HOS',
  'print'     => 'HEAD DEPT UNIQ JKT,PIC STAFF UNIQ JKT,AP STAFF,SUPER ADMIN,BUDGETCONTROL,VP FINANCE,PIC STAFF,HEAD OF SCHOOL,CHIEF OPERATION OFFICER,FINANCE MANAGER,CHIEF OF FINANCE,PIC PROCUREMENT,ASSISTANT HOS',
