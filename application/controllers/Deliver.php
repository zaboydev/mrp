...
class Deliver extends MY_Controller
{
  ...
  public function __construct()
  {
    ...
    $this->module = $this->modules['deliver'];
  ...
  public function index()
  {
    ...
    $this->data['page']['title']            = 'Deliver To';
  ...
  public function save()
  {
    ...
    if (is_granted($this->module, 'save') === FALSE){
      ...
      if ($this->input->post('id')){
        if ($this->model->isDeliveryToExists($this->input->post('warehouse'), NULL, $this->input->post('warehouse_exception'))){
          $return['type'] = 'danger';
        ...
        if ($this->model->isDeliveryToExists($this->input->post('warehouse'))){
          $return['type'] = 'danger';
          $return['info'] = 'Duplicate Deliver Place! The Place '. $this->input->post('warehouse') .' already exists.';
        } else {
