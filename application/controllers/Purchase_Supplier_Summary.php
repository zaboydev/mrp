...
class Purchase_Supplier_Summary extends MY_Controller
{
    protected $module;
    protected $id_item = 0;
    ...
    public function __construct()
    {
        ...
        $this->module = $this->modules['purchase_supplier_summary'];
    ...
    public function getPo()
    {
        ...
        $items = $this->model->getPurchaseSummary($vendor, $currency, $date);
