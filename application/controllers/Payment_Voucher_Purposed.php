...
class Payment_Voucher_Purposed extends MY_Controller
{
    protected $module;
    ...
    public function __construct()
    {
        ...
        $this->module = $this->modules['payment_voucher_purposed'];
    ...
    public function create($category = NULL)
    {
        ...
        $this->data['page']['title']      = 'create capex payment request';
