...
class Aircraft_Mapping_Part extends MY_Controller
{
    protected $module;
    ...
    public function __construct()
    {
        ...
        $this->module = $this->modules['aircraft_mapping_part'];
    ...
    public function add_item()
    {
        ...
        if (isset($_POST) && !empty($_POST)){
            $_SESSION['movement_part']['items'][] = array(
                ...
                'remarks_install'     => ($_SESSION['movement_part']['type']=='remove')? NULL:$this->input->post('remarks_install'), 
            );
