...
class Expense_Item extends MY_Controller
{
  protected $module;
  ...
  public function __construct()
  {
    ...
    $this->module = $this->modules['expense_item'];
  ...
  public function create()
  {
    ...
    if (is_granted($this->module, 'create') === FALSE){
      ...
      $return['type'] = 'success';
      $this->data['entity']['accounts'] = $this->model->getAccounts();
