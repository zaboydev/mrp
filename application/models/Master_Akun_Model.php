...
class Master_Akun_Model extends MY_Model
{
    protected $module;
    ...
    public function __construct()
    {
        ...
        $this->module = config_item('module')['master_akun'];
    }
    ...
    {
        $this->db->where('id', $id);
        $query = $this->db->get('tb_master_akun');
