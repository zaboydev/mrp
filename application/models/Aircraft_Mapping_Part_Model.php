...
class Aircraft_Mapping_Part_Model extends MY_Model
{
    protected $module;
    ...
    public function __construct()
    {
        ...
        $this->module = config_item('module')['aircraft_mapping_part'];
    }
    ...
    function getIndex($return = 'array')
    {
        ...
        if (isset($_POST['order'])){
            ...
            $this->db->order_by('tb_aircraft_mapping_parts.id','asc');
        }
