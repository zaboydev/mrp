...
class Capex_Order_Evaluation_Model extends MY_Model
{
  ...
  public function save()
  {
    ...
    $document_id          = (isset($_SESSION['capex_poe']['id'])) ? $_SESSION['capex_poe']['id'] : NULL;
    $document_edit        = (isset($_SESSION['capex_poe']['edit'])) ? $_SESSION['capex_poe']['edit'] : NULL;
    $document_number      = $_SESSION['capex_poe']['document_number'] . poe_format_number();
    $document_date        = $_SESSION['capex_poe']['document_date'];
    $created_by           = (empty($_SESSION['capex_poe']['created_by'])) ? NULL : $_SESSION['capex_poe']['created_by'];
    $document_reference   = (empty($_SESSION['capex_poe']['document_reference'])) ? NULL : $_SESSION['capex_poe']['document_reference'];
    $approved_by          = (empty($_SESSION['capex_poe']['approved_by'])) ? NULL : $_SESSION['capex_poe']['approved_by'];
    $status               = 'evaluation';
    $warehouse            = $_SESSION['capex_poe']['warehouse'];
    $category             = $_SESSION['capex_poe']['category'];
    $default_currency     = $_SESSION['capex_poe']['default_currency'];
    $approval             = $_SESSION['capex_poe']['approval'];
     ...
     * PROCESSING VENDORS
     */
    foreach ($_SESSION['capex_poe']['vendors'] as $key => $vendor) {
