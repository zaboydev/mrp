...
class Inventory_Purchase_Order_Model extends MY_Model
{
  ...
  public function send_mail($doc_id, $level)
  {
    ...
    $message .= "<p>Berikut permintaan Persetujuan untuk Inventory Purchase Order :</p>";
    $message .= "<ul>";
    $message .= "</ul>";
    ...
    $this->email->subject('Permintaan Approval Inventory Purchase Order No : ' . $row['document_number']);
