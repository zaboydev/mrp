...
class Konsolidasi_Model_2 extends MY_Model
{
  protected $module;
  ...
  function getIndex($return = 'array')
  {
    ...
    $this->db->join('tb_receipts','tb_master_item_categories.category = tb_receipts.category');
    $this->db->join('tb_receipt_items','tb_receipt_items.document_number = tb_receipts.document_number');

    $this->db->join('tb_issuances','tb_master_item_categories.category = tb_issuances.category');
    $this->db->join('tb_issuance_items','tb_issuances.document_number = tb_issuance_items.document_number');
