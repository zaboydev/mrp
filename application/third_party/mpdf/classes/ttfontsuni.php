...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	function extractInfo($debug=false, $BMPonly=false, $useOTL=0) {
		...
		///////////////////////////////////
			...
			if ($names[4]) { $this->person_name = $names[4]; } else { $this->person_name = $psName; }
			if ($names[3]) { $this->uniqueFontID = $names[3]; } else { $this->uniqueFontID = $psName; }

			if (!$psNameInvalid && $names[6]) { $this->person_name = $names[6]; }
...
$subRule = array();
						...
						// Format 3: Coverage-based Context Glyph Substitution  p259
							...
							// Ignonotes flag set on main Lookup table
							$ignore = $this->_getGSUBignoreString($Lookup[$i]['Flag'], $Lookup[$i]['MarkFilteringSet']);
