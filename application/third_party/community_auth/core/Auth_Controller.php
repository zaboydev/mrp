...
class Auth_Controller extends CI_Controller {
	...
	protected function _set_user_variables()
	{
		...
		$this->auth_person_name = $this->auth_data->person_name;
		$this->auth_warehouse = $this->auth_data->warehouse;
		...
		$data = array(
			...
			'auth_person_name' => $this->auth_person_name,
			'auth_warehouse' => $this->auth_warehouse
		);
		...
		$this->config->set_item( 'auth_person_name', $this->auth_person_name );
		$this->config->set_item( 'auth_warehouse', $this->auth_warehouse );
